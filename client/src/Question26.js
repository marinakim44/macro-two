    ...
    <div className="main">
      <div className="sticky-sub-div">
        ...
        <div className="left-align-text">
          ...
          <p>
            В январе 2020 года Комитет по денежно-кредитной политике НБРК принял
            решение установить базовую ставку на уровне 10,25% годовых с
            процентным коридором +/– 1,00 п.п.
          </p>
